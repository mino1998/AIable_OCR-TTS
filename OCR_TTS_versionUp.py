/**
* Original Code
* https://github.com/afaq-ahmad/Python-Application-for-Camera-OCR-then-text-to-speech/blob/master/ocr_text_to_speech.py
* modified by mino1998
*/
...
class RecordVideo(QtCore.QObject):
    ...
    def framesave(self):
        ...
        if read:
            ...
            if len(text) > 0:
                tts = gTTS(text=text, lang='ko')  # for english language use (lang='en')
